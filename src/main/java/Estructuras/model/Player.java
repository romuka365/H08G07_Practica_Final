...
public class Player<T extends Comparable<T>> {
    ...
    private int money;
    private int mov;
    private ListaSE<T> inventory; //CAMBIAR POR LISTA CORRESPONDIENTE
    ...
    public Player(Boolean death, int maxHealth, int def, int atk, int money, int mov, ListaSE<T> inventory) //para cuando nos den los datos
    {
        this.death = death;
